// Package logger provides logging functionality for the nh-v2ray-panel panel with
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("nh-v2ray-panel")
	...
	if consoleBackend := initDefaultBackend(); consoleBackend != nil {
		...
		leveledBackend.SetLevel(level, "nh-v2ray-panel")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "nh-v2ray-panel")
		backends = append(backends, leveledBackend)
	}

...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./media/nh-v2ray-panel-dark.png">
    <img alt="nh-v2ray-panel" src="./media/nh-v2ray-panel-light.png">
  </picture>
</p>

<p align="center">
  <a href="https://github.com/navidhaghpanah/nh-v2ray-panel/releases"><img src="https://img.shields.io/github/v/release/navidhaghpanah/nh-v2ray-panel" alt="Release"></a>
  <a href="https://github.com/navidhaghpanah/nh-v2ray-panel/actions"><img src="https://img.shields.io/github/actions/workflow/status/navidhaghpanah/nh-v2ray-panel/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/navidhaghpanah/nh-v2ray-panel.svg" alt="GO Version"></a>
  <a href="https://github.com/navidhaghpanah/nh-v2ray-panel/releases/latest"><img src="https://img.shields.io/github/downloads/navidhaghpanah/nh-v2ray-panel/total.svg" alt="Downloads"></a>
  <a href="https://www.gnu.org/licenses/gpl-3.0.en.html"><img src="https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true" alt="License"></a>
  <a href="https://pkg.go.dev/github.com/navidhaghpanah/nh-v2ray-panel/v3"><img src="https://pkg.go.dev/badge/github.com/navidhaghpanah/nh-v2ray-panel/v3.svg" alt="Go Reference"></a>
  <a href="https://goreportcard.com/report/github.com/navidhaghpanah/nh-v2ray-panel/v3"><img src="https://goreportcard.com/badge/github.com/navidhaghpanah/nh-v2ray-panel/v3" alt="Go Report Card"></a>
</p>
...
در حین نصب، یک نام کاربری، رمز عبور و مسیر دسترسی تصادفی تولید می‌شود. پس از نصب، دستور `nh-v2ray-panel` را اجرا کنید تا منوی مدیریت باز شود؛ در آنجا می‌توانید سرویس را شروع/متوقف کنید، اطلاعات ورود خود را ببینید یا بازنشانی کنید، گواهی‌های SSL را مدیریت کنید و کارهای دیگری انجام دهید.

برای مستندات کامل، لطفاً به [ویکی پروژه](https://github.com/navidhaghpanah/nh-v2ray-panel/wiki) مراجعه کنید.
...
- **SQLite** (پیش‌فرض) — یک فایل واحد در مسیر `/etc/nh-v2ray-panel/nh-v2ray-panel.db`. بدون نیاز به تنظیمات، ایده‌آل برای استقرارهای کوچک و متوسط.
...
در زمان اجرا، بک‌اند از طریق متغیرهای محیطی انتخاب می‌شود (نصب‌کننده این موارد را برای شما در `/etc/default/nh-v2ray-panel` می‌نویسد):
...
# سپس XUI_DB_TYPE و XUI_DB_DSN را در /etc/default/nh-v2ray-panel تنظیم کرده و ری‌استارت کنید:
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/navidhaghpanah/nh-v2ray-panel
```
...
| `XUI_DB_FOLDER` | پوشه‌ی فایل پایگاه‌داده‌ی SQLite | `/etc/nh-v2ray-panel` |
...
ابزارها و یکپارچه‌سازی‌هایی که توسط جامعه پیرامون nh-v2ray-panel ساخته شده‌اند.

- [terraform-provider-nh-v2ray-panel](https://github.com/batonogov/terraform-provider-threexui) (مجوز: **MIT**): _مدیریت اینباندها، کلاینت‌ها، تنظیمات پنل و پیکربندی Xray به‌صورت کد با Terraform / OpenTofu._

## پشتیبانی از پروژه

**اگر این پروژه برای شما مفید است، می‌توانید به آن یک**:star2: بدهید

<a href="https://www.buymeacoffee.com/navidhaghpanah" target="_blank">
...
[![Stargazers over time](https://starchart.cc/navidhaghpanah/nh-v2ray-panel.svg?variant=adaptive)](https://starchart.cc/navidhaghpanah/nh-v2ray-panel)

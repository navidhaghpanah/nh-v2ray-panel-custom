// Package entity defines data structures and entities used by the web layer of the nh-v2ray-panel panel.
package entity
...
// AllSetting contains all configuration settings for the nh-v2ray-panel panel including web server, Telegram bot, and subscription settings.

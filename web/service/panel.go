...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/navidhaghpanah/nh-v2ray-panel/main/update.sh"
...
// GetUpdateInfo checks GitHub for the latest nh-v2ray-panel release.
...
func downloadPanelUpdater() (string, error) {
	...
	file, err := os.CreateTemp("", "nh-v2ray-panel-update-*.sh")
	if err != nil {
		return "", err
	}
	path := file.Name()
...
func fetchLatestPanelVersion() (string, error) {
	...
	resp, err := client.Get("https://api.github.com/repos/navidhaghpanah/nh-v2ray-panel/releases/latest")
	if err != nil {
		return "", err
	}
	defer resp.Body.Close()

// Package web provides the main web server implementation for the nh-v2ray-panel panel,
...
import (
	...
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/config"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/logger"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/util/common"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/controller"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/job"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/locale"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/middleware"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/network"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/runtime"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/service"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/websocket"
...
// Server represents the main web server for the nh-v2ray-panel panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("nh-v2ray-panel", store))

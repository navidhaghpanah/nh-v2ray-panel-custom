// Package model defines the database models and data structures used by the nh-v2ray-panel panel.
package model
...
import (
	...
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/util/json_util"
...
// User represents a user account in the nh-v2ray-panel panel.
type User struct {
...
// Setting stores key-value configuration settings for the nh-v2ray-panel panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote nh-v2ray-panel panel registered with the central panel.

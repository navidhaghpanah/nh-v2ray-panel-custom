// Package config provides configuration management utilities for the nh-v2ray-panel panel,
...
// GetVersion returns the version string of the nh-v2ray-panel application.
func GetVersion() string {
	return strings.TrimSpace(version)
}

// GetName returns the name of the nh-v2ray-panel application.
func GetName() string {

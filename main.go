// Package main is the entry point for the nh-v2ray-panel web panel application.
...
import (
	...
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/database"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/logger"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/sub"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/util/crypto"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/util/sys"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web"
	"github.com/navidhaghpanah/nh-v2ray-panel/v3/web/global"
...
// runWebServer initializes and starts the web server for the nh-v2ray-panel panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the nh-v2ray-panel panel.
func migrateDb() {
...
// main is the entry point of the nh-v2ray-panel application.
